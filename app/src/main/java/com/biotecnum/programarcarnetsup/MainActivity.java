package com.biotecnum.programarcarnetsup;
...
public class MainActivity extends AppCompatActivity {
    ...
    private String correo = "ingluismb@gmail.com", pass = "qwertyuiop";
    ...
    public void onStart() {
        ...
        mConditionRef = FirebaseDatabase.getInstance().getReference().child("carnets/");
        mConditionRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                mConditionRef.child("total").setValue(T);

                tvTotal.setText("Total: " + new BigDecimal(T).toString());
                //}
            }
    ...
    protected void onNewIntent(Intent intent) {
        ...
        if(intent.hasExtra(NfcAdapter.EXTRA_TAG)){
            ...
            mDatabaseT = FirebaseDatabase.getInstance().getReference().child("carnets/"+id);
            mDatabaseT.addListenerForSingleValueEvent(new ValueEventListener() {
                ...
                public void onDataChange(DataSnapshot dataSnapshot) {
                    ...
                    if(infoT == null) {
                        ...
                        ///////////
                        mDatabase = FirebaseDatabase.getInstance().getReference().child("carnets/");
